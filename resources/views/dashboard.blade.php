...
<!-- Mirrored from admin.pixelstrap.net/crocs/template/task.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 06:17:32 GMT -->
<head>
    ...
    <link rel="icon" href="https://admin.pixelstrap.net/crocs/assets/images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="https://admin.pixelstrap.net/crocs/assets/images/favicon.png" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/font-awesome.css">
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/icofont.css">
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/themify.css">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/flag-icon.css">
    <!-- Feather icon-->
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/feather-icon.css">
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/slick.css">
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/slick-theme.css">
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/scrollbar.css">
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/animate.css">
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/select2.css">
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/date-picker.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/vendors/bootstrap.css">
    <!-- App css-->
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/style.css">
    <link id="color" rel="stylesheet" href="https://admin.pixelstrap.net/crocs/assets/css/color-1.css" media="screen">
    <!-- Responsive css-->
    <link rel="stylesheet" type="text/css" href="https://admin.pixelstrap.net/crocs/assets/css/responsive.css">
  </head>
  <body> 
    <!-- loader starts-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="https://admin.pixelstrap.net/crocs/assets/images/logo/logo-1.png" alt=""><img class="img-fluid for-dark" src="https://admin.pixelstrap.net/crocs/assets/images/logo/logo.png" alt=""></a></div>
            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown">
                ...
                <div class="onhover-show-div notification-dropdown">
                  ...
                  <div class="d-flex align-items-center"><img src="https://admin.pixelstrap.net/crocs/assets/images/dashboard/user/5.png" alt="">
                  ...
                  <div class="d-flex align-items-center"><img src="https://admin.pixelstrap.net/crocs/assets/images/dashboard/user/6.png" alt="">
                    <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                        <h5>
                  ...
                  <div class="d-flex align-items-center figma-line"><img src="https://admin.pixelstrap.net/crocs/assets/images/dashboard/user/7.png" alt="">
                    <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                  ...
                  <ul>
                    <li>
                      <div class="d-flex align-items-start">
                        <div class="message-img bg-light-primary"><img src="https://admin.pixelstrap.net/crocs/assets/images/user/3.jpg" alt=""></div>
                    ...
                    <li>
                      <div class="d-flex align-items-start">
                        <div class="message-img bg-light-primary"><img src="https://admin.pixelstrap.net/crocs/assets/images/user/6.jpg" alt=""></div>
                        <div class="flex-grow-1">
                    ...
                    <li>
                      <div class="d-flex align-items-start">
                        <div class="message-img bg-light-primary"><img src="https://admin.pixelstrap.net/crocs/assets/images/user/10.jpg" alt=""></div>
                        <div class="flex-grow-1">
              ...
              <li class="cart-nav onhover-dropdown">
                ...
                <div class="cart-dropdown onhover-show-div">
                  ...
                  <ul>
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 img-60" src="https://admin.pixelstrap.net/crocs/assets/images/ecommerce/06.jpg" alt="">
                    ...
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 img-60" src="https://admin.pixelstrap.net/crocs/assets/images/ecommerce/02.jpg" alt="">
              ...
              <li class="profile-nav onhover-dropdown p-0">
                <div class="d-flex align-items-center profile-media"><img class="b-r-10 img-40" src="https://admin.pixelstrap.net/crocs/assets/images/dashboard/profile.png" alt="">
                ...
                <ul class="profile-dropdown onhover-show-div">
                  ...
                  <li>
                         <form method="POST" action="{{ route('logout') }}">
                             @csrf
                            <button type="submit" style="border:none; background:none; padding:0; margin:0; display:flex; align-items:center;">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper" data-layout="fill-svg">
          <div>
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="https://admin.pixelstrap.net/crocs/assets/images/logo/logo.png" alt=""></a>
              <div class="toggle-sidebar">
                <svg class="sidebar-toggle"> 
            ...
            <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="https://admin.pixelstrap.net/crocs/assets/images/logo/logo-icon.png" alt=""></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="index.html"><img class="img-fluid" src="https://admin.pixelstrap.net/crocs/assets/images/logo/logo-icon.png" alt=""></a>
    ...
    <!-- latest jquery-->
    <script src="https://admin.pixelstrap.net/crocs/assets/js/jquery.min.js"></script>
    <!-- Bootstrap js-->
    <script src="https://admin.pixelstrap.net/crocs/assets/js/bootstrap/bootstrap.bundle.min.js"></script>
    <!-- feather icon js-->
    <script src="https://admin.pixelstrap.net/crocs/assets/js/icons/feather-icon/feather.min.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/icons/feather-icon/feather-icon.js"></script>
    <!-- scrollbar js-->
    <script src="https://admin.pixelstrap.net/crocs/assets/js/scrollbar/simplebar.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/scrollbar/custom.js"></script>
    <!-- Sidebar jquery-->
    <script src="https://admin.pixelstrap.net/crocs/assets/js/config.js"></script>
    <!-- Plugins JS start-->
    <script src="https://admin.pixelstrap.net/crocs/assets/js/sidebar-menu.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/sidebar-pin.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/slick/slick.min.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/slick/slick.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/header-slick.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/datepicker/date-picker/datepicker.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/datepicker/date-picker/datepicker.en.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/datepicker/date-picker/datepicker.custom.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/select2/select2.full.min.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/select2/select2-custom.js"></script>
    <script src="https://admin.pixelstrap.net/crocs/assets/js/form-validation-custom.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
